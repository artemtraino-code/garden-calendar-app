...
const SEED: AppState = {
  ...
  tasks: [
    {
      id: "import_20260504_treat_petunia_veggies",
      batchId: "import_20260504",
      status: "done",
      date: "2026-05-04",
      groupIds: ["g_flowers", "g_veggies"],
      cultureIds: ["c_petunia", "c_tomato", "c_pepper"],
      workTypeIds: ["w_treat"],
      preparationIds: ["prep_topas", "prep_vertimek", "prep_megafol"],
      repeat: { mode: "none", intervalDays: 0, repeatDate: "" },
      notes: "Баковая смесь: Топас + Вертимек + Мегафол. Обработка петуний и овощей.",
      createdAt: "2026-05-04",
      updatedAt: "2026-05-04",
    },
    {
      id: "import_20260505_feed_strawberry_boro",
      batchId: "import_20260505",
      status: "done",
      date: "2026-05-05",
      groupIds: ["g_berries"],
      cultureIds: ["c_strawberry"],
      workTypeIds: ["w_feed"],
      preparationIds: ["prep_boro_plus"],
      repeat: { mode: "none", intervalDays: 0, repeatDate: "" },
      notes: "Листовая или корневая подкормка клубники препаратом Боро Плюс.",
      createdAt: "2026-05-05",
      updatedAt: "2026-05-05",
    },
    {
      id: "import_20260506_treat_roses",
      batchId: "import_20260506",
      status: "done",
      date: "2026-05-06",
      groupIds: ["g_flowers"],
      cultureIds: ["c_rose"],
      ...
      repeat: { mode: "none", intervalDays: 0, repeatDate: "" },
      notes: "Обработка роз баковой смесью: Топас + Вертимек.",
      createdAt: "2026-05-06",
      updatedAt: "2026-05-06",
    },
    {
      id: "import_20260515_treat_tomato_pepper_megafol",
      batchId: "import_20260515_megafol",
      status: "done",
      date: "2026-05-15",
      groupIds: ["g_veggies"],
      ...
      repeat: { mode: "none", intervalDays: 0, repeatDate: "" },
      notes: "Обработка томатов и перцев Мегафолом за день до высадки.",
      createdAt: "2026-05-15",
      updatedAt: "2026-05-15",
    },
    {
      id: "import_20260515_treat_tomato_pepper_aktara_previkur",
      batchId: "import_20260515_aktara_previkur",
      status: "done",
      date: "2026-05-15",
      groupIds: ["g_veggies"],
      cultureIds: ["c_tomato", "c_pepper"],
      ...
      repeat: { mode: "none", intervalDays: 0, repeatDate: "" },
      notes: "Пролив помидоров и перцев препаратами Актара и Превикур.",
      createdAt: "2026-05-15",
      updatedAt: "2026-05-15",
    },
    {
      id: "import_20260515_feed_strawberry_boro_repeat",
      batchId: "import_20260515_boro_repeat",
      status: "done",
      date: "2026-05-15",
      groupIds: ["g_berries"],
      cultureIds: ["c_strawberry"],
      ...
      preparationIds: ["prep_boro_plus"],
      repeat: { mode: "none", intervalDays: 0, repeatDate: "" },
      notes: "Повторная подкормка Боро Плюс в фазе активного цветения для лучшей завязи ягод. Прошлый раз был 5 мая.",
      createdAt: "2026-05-15",
      updatedAt: "2026-05-15",
    },
    {
      id: "import_20260517_plant_tomato_pepper",
      batchId: "import_20260517",
      status: "done",
      date: "2026-05-17",
      groupIds: ["g_veggies"],
      cultureIds: ["c_tomato", "c_pepper"],
      ...
      preparationIds: [],
      repeat: { mode: "none", intervalDays: 0, repeatDate: "" },
      notes: "Высадка рассады томатов и перца в открытый грунт.",
      createdAt: "2026-05-17",
      updatedAt: "2026-05-17",
    },
    {
      id: "import_20260518_repeat_treat_petunia_veggies",
      batchId: "import_20260518",
      status: "done",
      date: "2026-05-18",
      groupIds: ["g_flowers", "g_veggies"],
      cultureIds: ["c_petunia", "c_tomato", "c_pepper"],
    ...
    {
      id: "import_20260520_treat_seedlings_previkur",
      batchId: "import_20260520",
      status: "planned",
      date: "2026-05-20",
      groupIds: ["g_veggies"],
      cultureIds: ["c_tomato", "c_pepper"],
      workTypeIds: ["w_treat"],
      preparationIds: ["prep_previkur"],
      repeat: { mode: "none", intervalDays: 0, repeatDate: "" },
      notes: "Обработка рассады Превикуром за 3 дня до высадки.",
      createdAt: "2026-05-20",
      updatedAt: "2026-05-20",
    },
    {
      id: "import_20260527_feed_treat_tomato_pepper",
      batchId: "import_20260527",
      status: "planned",
      date: "2026-05-27",
      groupIds: ["g_veggies"],
      cultureIds: ["c_tomato", "c_pepper"],
      workTypeIds: ["w_feed", "w_treat"],
      preparationIds: ["prep_master_202020"],
      repeat: { mode: "none", intervalDays: 0, repeatDate: "" },
      notes: "Первая корневая подкормка комплексным удобрением Мастер 20-20-20 для высаженной 17 мая рассады томатов и перца.",
